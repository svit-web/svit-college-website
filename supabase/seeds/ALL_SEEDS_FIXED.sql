-- ============================================
-- SVIT DATABASE SEEDING - CORRECTED VERSION
-- ============================================
-- Run this in Supabase SQL Editor
-- Matches actual database schema (no description/established_year columns)
-- ============================================
...
-- Continue with committees, accreditations, placement in next file...

...
export const Route = createFileRoute("/about/history-vision-mission")({
  head: () => ({
    meta: [
      { title: "History, Vision & Mission — SVIT Vasad" },
      {
        name: "description",
        content: "SVIT Vasad's history and milestones since 1997, our vision, mission and core values.",
      },
    ],
  }),
  component: HistoryVisionMissionPage,
});

function HistoryVisionMissionPage() {

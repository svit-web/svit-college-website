...
async function loadCoe() {
  const center = await getCenterBySlug("coe");
    ...
    <div className="space-y-8">
      ...
      <Reveal>
        {item.photos.length > 0 ? (
          <PhotoSlider photos={item.photos} ariaLabel="Centre of Excellence photos" photoAlt="Centre of Excellence activity photo" />
        ) : (

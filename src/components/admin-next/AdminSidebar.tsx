...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Student Groups — Clubs', to: '/admin/tables/student_clubs' },
      { label: 'Student Groups — Club Events', to: '/admin/tables/club_events' },
      { label: 'Student Groups — Societies', to: '/admin/tables/centers' },

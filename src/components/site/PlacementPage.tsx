      ...
      <div className="bg-secondary/30">
        <div className="container-page py-10">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[300px_minmax(0,1fr)]">
            ...
            <div className="min-w-0 flex-1 space-y-8 [&>section]:scroll-mt-24">
              {/* 1. About T&P Cell */}
              {content.slug === "overview" && (
              ...
              <section id="summary" className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                      ...
                      <div className="card-lift flex flex-col overflow-hidden rounded-2xl border-2 border-navy/15 bg-white hover:border-gold transition-colors">
                        <div className="aspect-square w-full bg-secondary/30 flex items-center justify-center relative overflow-hidden">
                          {s.photo || content.defaultStudentPlaceholderUrl ? (
                            <img src={s.photo || content.defaultStudentPlaceholderUrl!} alt={s.studentName} className="h-full w-full object-cover" />
                          ) : (
                  ...
                  {content.summary.placedStudents.length === 0 && (
                    <div className="col-span-2 sm:col-span-3 md:col-span-4 lg:col-span-5 rounded-2xl border-2 border-dashed border-navy/15 bg-secondary/40 p-5 text-center text-[11px] font-semibold uppercase tracking-widest text-muted-foreground flex items-center justify-center">
